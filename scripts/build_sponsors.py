...
SPONSOR_MAP: list[tuple[str, str, str | None]] = [
    ...
    ("Douceur et Passion", "Douceur et Passion", "sponsors/Douceur et passion.png"),
    ("le Ponant", "Le Ponant", "sponsors/le ponant.png"),
    ("Merssy", "Merssy", "sponsors/merssy.jpeg"),
    ("Les Goulus", "Les Goulus", "sponsors/Les goulus.jpeg"),
    ("Dara", "Dara", "sponsors/DAra.jpeg"),
    ("Mademoiselle Souris", "Mademoiselle Souris", "sponsors/mlle souris.jpeg"),
    ("A Cantina", "A Cantina", "sponsors/A cantina.jpeg"),
    ...
    ("Les Jardins de Brocéliande", "Les Jardins de Brocéliande", "sponsors/Les jardins de brocéliande.jpeg"),
